...
class RunSummaryPageServiceTest {
    ...
    void usesProjectionAndSelectsHighestRankedPreviewWithCount() {
        ...
        when(runQueryService.listPipelineRunsPage(null, 0, 20, "createdAt", null)).thenReturn(new PageImpl<>(List.of(run)));
        ...
        PageResponse<RunSummary> page = service.list(null, 0, 20, "createdAt", null);
