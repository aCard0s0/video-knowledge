...
@Tag("integration")
class VidIngestMcpIntegrationTest extends BaseVidingestMcpIntegrationTest {
    ...
    @Test
    void startsWithMvcMcpTransportEnabled() {
        assertThat(applicationContext.containsBean("webMvcSseServerTransportProvider")).isTrue();
        assertThat(applicationContext.containsBean("mvcMcpRouterFunction")).isTrue();
    }
}
