...
| **what a press does** on any screen | [actionState](../objects/console/action-state.md). Six screens read its four signals in their templates; `cancel()` and `disarm()` are not interchangeable |
