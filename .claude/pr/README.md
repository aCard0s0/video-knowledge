...
| PR | Date | Summary |
|----|------|---------|
| [#8](pr-008-phase-toggle-and-read-model.md) | 2026-08-25 | Six positional skip booleans collapse into one `skipPhases` set; one writer for `PipelineRun` status; one copy of run-preview ranking; run items leased so instances stop reaping each other |
